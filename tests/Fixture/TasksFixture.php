...
class TasksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'tasks_ibfk_1' => ['type' => 'foreign', 'columns' => ['project_id'], 'references' => ['projects', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'complete' => 1,
            'project_id' => 1,
            'created' => '2017-12-09 04:32:24',
            'modified' => '2017-12-09 04:32:24'
        ],
    ];
}
